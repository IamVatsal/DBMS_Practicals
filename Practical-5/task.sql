...
-- Query 7a: Orders on Oct 3rd or 4th 2020 using BETWEEN
...
-- Query 7b: Orders on Oct 3rd or 4th 2020 using OR
...
-- Additional dates example
SELECT * FROM order_info 
WHERE odate = '2020-04-10' OR odate = '2020-05-04';

-- Query 8: Orders without ZEROS or NULLS in amount
...
-- Query 26: Customers with rating greater than any customer in ROME
